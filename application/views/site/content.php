...
<div id="slide">
	<div id="img-slide" class="sliderContainer" style="width:580px">
		<div id="HomeSlide" class="royalSlider rsMinW rsHor rsWithBullets" style="height: 205px;"><div class="rsOverflow" style="cursor: -webkit-grab; width: 580px; height: 205px;"><div class="rsContainer" style="transition-duration: 600ms; transform: translate3d(-588px, 0px, 0px); transition-timing-function: cubic-bezier(0.445, 0.05, 0.55, 0.95);"><div style="left: 0px;" class="rsSlide "><a href="http://dantri.com.vn/" target="_blank" style="visibility: visible; opacity: 1; transition: opacity 400ms ease-in-out;"><img src="../upload/slide/31.jpg"> </a></div><div style="left: 588px;" class="rsSlide "><a href="http://dantri.com.vn/" target="_blank"><img src="../upload/slide/21.jpg"> </a></div><div style="left: 1176px;" class="rsSlide "><a href="http://dantri.com.vn/" target="_blank"><img src="../upload/slide/11.jpg"> </a></div></div></div><div class="rsNav rsBullets"><div class="rsNavItem rsBullet"><span></span></div><div class="rsNavItem rsBullet rsNavSelected"><span></span></div><div class="rsNavItem rsBullet"><span></span></div></div><div class="rsArrow rsArrowLeft" style="display: block;"><div class="rsArrowIcn"></div></div><div class="rsArrow rsArrowRight" style="display: block;"><div class="rsArrowIcn"></div></div></div>
	</div>
	<div class="clear"></div>
</div>
